    ...
    <MotionWrap className="w-full py-24 lg:py-32" id="about">
      <div className="space-y-4 px-4 md:px-6 lg:space-y-10">
        ...
        <div className="space-y-4">
          ...
          <Button asChild>
            <Link
              href="https://www.npassim.com/1?data="
              target="_blank"
            >
