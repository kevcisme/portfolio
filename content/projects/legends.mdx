...
Started to slowly sneak in some Bayesian models that create scenarios of how the winner might win (e.g. "Joe can win if Rory shoots less than 70 and Scottie shoots less than 67").

I had been wanting to work on web dev skills. I had heard about Clerk from web dev friends so I decided to use that for authentication, and then deployed the whole thing on AWS.
